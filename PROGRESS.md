...
| **诊断游戏** | 1150×680 | 144%×113% | ✅ 已修复 |
| **煎药游戏** | 1150×680 | 144%×113% | ✅ 已修复 |
| **炮制游戏** | 100vw×100vh | 全屏 | ✅ 已修复 |
| **背包游戏** | 90vw×85vh | 响应式 | ✅ 相对合理 |

### 规范文档

**文件**: `docs/superpowers/specs/phase2.5/2026-05-07-html-game-embedding-size-spec.md`

**核心标准**: HTML小游戏容器尺寸适配游戏窗口（800×600）
- 推荐方案: `min(760px, 90vw) × min(560px, 85vh)`
