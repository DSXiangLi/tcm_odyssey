...
| **Phase 2.5 诊断HTML直接迁移** | ✅ 完成+验收 | 场景切换修复+UI尺寸调整+E2E验收通过 (2026-04-30) |
| **Phase 2.5 NPC AI验收系统** | ✅ 完成 | LLM评估器+报告生成+19个E2E测试场景 (2026-05-01) |
...
13个子系统全部完成：Hermes基础设施、NPC对话、问诊、病案、诊治游戏、存档、背包、煎药、炮制、种植、经验值、新手引导。详见[设计文档](docs/superpowers/specs/phase2/2026-04-12-phase2-npc-agent-design.md)。

---

### Phase 2.5: 小游戏系统 ✅

**已完成**: 煎药(ClinicScene D键)、炮制(GardenScene P键)、诊断(ClinicScene Z键，5阶段10病案)、UI组件基类(ModalUI/ScrollModalUI)、场景切换修复。

**待开发**: 种植小游戏(GardenScene G键入口已存在)。
