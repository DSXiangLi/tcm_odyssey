// src/ui/html/components/DiagnosisAssets.tsx
/**
 * 诊断游戏共享 SVG 资产 + 通用小组件
 *
 * 来源: docs/ui/诊断游戏/assets.jsx - 直接迁移
 * 创建日期: 2026-04-28
 * 内容: 舌象、患者立绘、印章、装饰组件
 */
 ...
 * 显示胖大舌体、齿痕、白厚腻苔、水滑高光
 */
export const TongueImage: React.FC<TongueImageProps> = ({ size = 280 }) => (
  <svg
    viewBox="0 0 320 360"
    width={size}
    height={size * 360 / 320}
  ...
  >
    ...
    {/* 口腔阴影 */}
    <ellipse cx="160" cy="180" rx="135" ry="160" fill="#3d1a18" opacity="0.6" />

    {/* 舌体 - 胡大 */}
    <path
      d="M 60 130 Q 60 80 160 75 Q 260 80 260 130 Q 270 230 230 295 Q 200 330 160 332 Q 120 330 90 295 Q 50 230 60 130 Z"
      fill="url(#tongueBody)"
    />

    {/* 齿痕 - 边缘的锯齿 */}
    {[0, 1, 2, 3, 4].map(i => (
      <ellipse key={`l${i}`} cx={62 + i * 2} cy={150 + i * 30} rx="6" ry="4" fill="#c08378" opacity="0.7" />
    ))}
    {[0, 1, 2, 3, 4].map(i => (
      <ellipse key={`r${i}`} cx={258 - i * 2} cy={150 + i * 30} rx="6" ry="4" fill="#c08378" opacity="0.7" />
    ))}

    {/* 白厚腻苔 */}
    <path
      d="M 80 125 Q 80 90 160 88 Q 240 90 240 125 Q 248 220 215 280 Q 190 312 160 314 Q 130 312 105 280 Q 72 220 80 125 Z"
      fill="url(#coatingFog)"
      filter="url(#softBlur)"
    />
    ...
    {/* 中线 */}
    <path d="M 160 110 Q 158 200 160 290" stroke="#a8746a" strokeWidth="1" fill="none" opacity="0.5" />

    {/* 水滑高光 */}
    <ellipse cx="135" cy="160" rx="35" ry="22" fill="url(#moistShine)" />
    <ellipse cx="200" cy="190" rx="18" ry="10" fill="url(#moistShine)" opacity="0.7" />
 ...
 * 显示写实国风风格的茶商妇人
 */
export const PatientPortrait: React.FC<PatientPortraitProps> = ({ height = 560 }) => (
  <svg viewBox="0 0 360 720" height={height} style={{ display: 'block' }}>
    ...
    {/* 外袍 */}
    <path
      d="M 60 340 Q 80 300 130 285 L 230 285 Q 280 300 300 340 L 320 720 L 40 720 Z"
      fill="url(#robeGrad)"
    />

    {/* 内衬 - V领 */}
    <path
      d="M 145 290 L 180 380 L 215 290 L 225 320 L 180 420 L 135 320 Z"
      fill="url(#innerRobe)"
    />
    ...
    <path d="M 145 545 Q 180 555 215 540" stroke="#a88555" strokeWidth="1" fill="none" opacity="0.6" />
    ...
    {/* 头发 - 后侧 */}
    <path d="M 110 180 Q 100 230 115 280 L 155 280 L 155 200 Z" fill="url(#hairGrad)" />
    <path d="M 250 180 Q 260 230 245 280 L 205 280 L 205 200 Z" fill="url(#hairGrad)" />
    ...
    {/* 头发 - 前侧、发髻 */}
    <path
      d="M 120 165 Q 130 110 180 105 Q 230 110 240 165 Q 240 145 215 138 Q 180 130 145 138 Q 120 145 120 165 Z"
      fill="url(#hairGrad)"
    />
    {/* 发髻 */}
    ...
    {/* 鼻 */}
    <path
      d="M 180 215 Q 178 230 175 240 Q 178 244 184 244 Q 188 240 184 235"
      stroke="#a8845a"
      strokeWidth="1"
      fill="none"
    />
 ...
 * 显示朱砂印章风格文字
 */
export const Seal: React.FC<SealProps> = ({ text = '杏林', size = 56, color }) => (
  <div
...
export type { TongueImageProps, PatientPortraitProps, SealProps };