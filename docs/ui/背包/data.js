...
// rarity: 1常见 2精良 3珍贵 4稀世 (决定边框/印章颜色)
// 紧凑数据：[id, name, cat, xing(性), wei(味), gui(归经), rarity, rawCount, pieceCount]
const _herbRows = [
  // 解表药
...
window.HERBS = _herbRows.map(r => ({
  id: r[0], name: r[1], cat: r[2], xing: r[3], wei: r[4], gui: r[5],
  rarity: r[6], rawCount: r[7], pieceCount: r[8]
}));
